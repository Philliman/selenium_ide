...
def convertFile(inputFile):
    for line in fileinput.input(folderPath+inputFile, inplace=1):
        sys.stdout.write(line.replace("Kathmandu | Shop Outdoor Clothing, Camping & Travel Gear UK", "Kathmandu: Outdoor Clothing, Camping & Travel Gear Online Shop | UK"))  # replace 'sit' and write
